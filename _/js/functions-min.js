!function(s){function o(){return window.print(),
...
/* 	BLOG SLIDE IN SIDEBAR BUTTON
		...
		*/
s("body").on(a,"button#sb-actions-btn",function(){return s(".slide-in-right").toggleClass("sb-closed sb-open"),!1}),
/* END OF BLOG SLIDE IN SIDEBAR BUTTON FUNCTIONS */
/* 	ROUTE FINDER BUTTON 
			Button functions for route finder pop up
		*/
s("body").on(a,"button#close-route-finder",function(){return s("#route-finder-pop-up").hasClass("on")&&(s("#route-finder-pop-up").removeClass("on").addClass("turn-off"),s(".turn-off").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",function(){s(this).removeClass("turn-off").addClass("off"),s("body").removeClass("route-finder-open")})),!1}),
...
//Button actions
s("body").on(a,"button#xmas-popup-btn-open",function(){return e(),!1}),s("#xmas-popup-wrap").on(a,"button#close-xmas-popup",function(t){
//console.log(e);
//xmasBoxClose();
...
/* VIDEO LINKS BUTTON ACTIONS
	    ...
	    */
s("a.video-link").on(a,function(){var t=s(this).attr("href"),n=s(t).find("video"),e=s(n).attr("id")+"-viewing";return s("body").addClass("video-open"),s("#video-viewer").animate({top:"0px",opacity:1},500,function(){s(this).toggleClass("viewer-closed viewer-open").removeAttr("style"),s(n).clone().attr("id",e).appendTo(".video-viewer-inner"),document.getElementById(e).play()}),!1}),s("button#close-video").on(a,function(){return s(this).parent().animate({top:"100%",opacity:0},500,function(){s(this).toggleClass("viewer-open viewer-closed").removeAttr("style"),s(this).find(".video-viewer-inner").empty(),s("body").removeClass("video-open")}),!1}),
/* POST GALLERY FUNCTION */
s("body").on(a,"a.gallery-img-link",function(){s(this).parent().siblings().removeClass("active"),s(this).parent().addClass("active");var t=s(this).attr("href"),n=s(".gallery-items-viewer"),e=new Image;return s(n).empty(),s(e).attr("src",t).addClass("animated fadeIn").appendTo(n),console.log(e),!1}),
...
s(window).bind("load",function(){s("body").removeClass("loading atfc-desktop-css"),s("head").find("#critical-css").remove(),1===s("#wide-map-canvas").length&&initMap(),1===s("#recent-blog-sb").length&&(s("#recent-blog-sb").show(),setTimeout(function(){s("#recent-blog-sb").removeClass("animated slideInLeft").toggleClass("sb-closed sb-open")},3e3),s("#recent-blog-sb").hasClass("sb-closed")&&setTimeout(function(){s("#recent-blog-sb").removeClass("sb-open").addClass("sb-closed")},7e3)),s(".has-bg-img").each(function(t,n){var e=s(n).data("src");
//console.log(src);
